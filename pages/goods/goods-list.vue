	...
	export default {
		data() {
			return {
				...
				orderbyList:[
					{text:"商品",selected:true,orderbyicon:false,orderby:0},
		...
		onLoad: function (option) { //option为object类型，会序列化上个页面传递的参数
			...
			var that = this 
			//var contactmsg = 
			request.get('/v1/goods/getlist/'+option.cid).then(function(res) {
				 console.log(res)
				 that.list=res.data
		...
		// 	}
		// 	let end_id = this.goodsList[len-1].id;
		// 	for(let i=1;i<=10;i++){
		// 		let id = end_id+i;
		// 		let p = { id: id, img: '../../static/img/goods/p'+(id%10==0?10:id%10)+'.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' };
