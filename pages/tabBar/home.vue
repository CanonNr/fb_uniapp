...
export default {
	data() {
		return {
			...
			// 分类菜单
			categoryList: [
				{ id: 1, name: '打车', img: '../../static/img/category/1.png' },
				{ id: 2, name: '送菜上门', img: '../../static/img/category/2.png' },
				{ id: 3, name: '送药上门', img: '../../static/img/category/3.png' },
				{ id: 4, name: '超市便利', img: '../../static/img/category/4.png' },
				{ id: 5, name: '免费零水果', img: '../../static/img/category/5.png' },
				{ id: 6, name: '生活服务', img: '../../static/img/category/6.png' },
				{ id: 7, name: '借钱', img: '../../static/img/category/7.png' },
				{ id: 8, name: '代购', img: '../../static/img/category/8.png' }
			],
			Promotion: [],
			//猜你喜欢列表 写死
			productList: [
